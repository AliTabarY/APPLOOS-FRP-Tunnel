...
# ==================================================================================
#
#   APPLOOS FRP TUNNEL - Full Management Script (v72.0 - Final Comprehensive)
...
EOF
    ...
    case $FRP_PROTOCOL in
        ...
        "kcp") echo "server_port = ${FRP_KCP_CONTROL_PORT}"; echo "transport.protocol = kcp" >> ${frpc_config_file} ;;
        "quic") echo "server_port = ${FRP_QUIC_CONTROL_PORT}"; echo "transport.protocol = quic" >> ${frpc_config_file} ;;
        "wss") echo "server_port = 443"; echo "transport.protocol = wss"; echo "tls_enable = true"; echo "server_name = ${FRP_DOMAIN}" >> ${frpc_config_file} ;;
    esac
...
main_menu() {
    while true; do
        ...
        echo "================================================="; echo -e "      ${CYAN}APPLOOS FRP TUNNEL${NC} - v72.0"; echo "================================================="
